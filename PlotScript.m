...
%% The plots I will put in the paper: Sigmas 5, 10, 20, and 25:
...
% Log scale L(z_1)-L^* vs time, using sigmas 5, 10, 20, and 25:
figure(7)
clf
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Trying some other comparisons here
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

figure(8)
clf
subplot(4,1,1),plotHarc(ta,ja,xa(:,1)); % Purple
grid on
axis([0 4 -30 60]);
xlabel('t','FontSize',16)
ylabel('z_1','FontSize',16)
subplot(4,1,2),plotHarc(tb,jb,xb(:,1)); % Red
grid on
axis([0 4 -30 60]);
xlabel('t','FontSize',16)
ylabel('z_1','FontSize',16)
subplot(4,1,3),plotHarc(td,jd,xd(:,1)); % Green
grid on
axis([0 4 -30 60]);
xlabel('t','FontSize',16)
ylabel('z_1','FontSize',16)
subplot(4,1,4),plotHarc(te,je,xe(:,1)); % Green
grid on
axis([0 4 -30 60]);
xlabel('t','FontSize',16)
ylabel('z_1','FontSize',16)
...
figure(9)
clf
subplot(4,1,1),semilogy(ta,lA,'Color',[0.4940 0.1840 0.5560],'LineWidth',1.5);
axis([0 2000 10^(-20) 10^(4)]);
set(gca,'ytick',[10^(-20) 10^(-10) 10^(0)])
xlabel('t','FontSize',16)
ylabel('L(z_1)-L^*','FontSize',16)
subplot(4,1,2),semilogy(tb,lB,'Color',[0.3010 0.7450 0.9330],'Linewidth',1.5);
axis([0 2000 10^(-20) 10^(4)]);
set(gca,'ytick',[10^(-20) 10^(-10) 10^(0)])
xlabel('t','FontSize',16)
ylabel('L(z_1)-L^*','FontSize',16)
subplot(4,1,3),semilogy(td,lD,'Color',[0.6350 0.0780 0.1840],'Linewidth',1.5);
axis([0 2000 10^(-20) 10^(4)]);
set(gca,'ytick',[10^(-20) 10^(-10) 10^(0)])
xlabel('t','FontSize',16)
ylabel('L(z_1)-L^*','FontSize',16)
subplot(4,1,4),semilogy(te,lE,'Color',[0.4660 0.6740 0.1880],'Linewidth',1.5);
axis([0 2000 10^(-20) 10^(4)]);
set(gca,'ytick',[10^(-20) 10^(-10) 10^(0)])
xlabel('t','FontSize',16)
ylabel('L(z_1)-L^*','FontSize',16)
